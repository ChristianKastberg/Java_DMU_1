...
// add new txf Hours and all that
public class EmployeePane extends GridPane {
	private TextField txfName, txfWage, txfYear, txfCompany, txfSalary;
	...
	public EmployeePane() {
		...
		this.add(lblYear, 1, 3);

		txfYear = new TextField();
		this.add(txfYear, 2, 3);
