...
public class Controller {
	 ...
	 * Requires: wage >= 0.
	 */
	public static Employee createEmployee(String name, int wage, int empYear) {
		Employee employee = new Employee(name, wage, empYear);
		Storage.addEmployee(employee);
		return employee;
		// tilføj year i parameter
	}
	 ...
	 */
	public static Employee createEmployee(String name, int wage, int empYear, Company company) {
		Employee employee = createEmployee(name, wage, empYear);
	 ...
	 * Requires: wage >= 0.
	 */
	public static void updateEmployee(Employee employee, String name, int wage, int empYear) {
		employee.setName(name);
		employee.setWage(wage);
		employee.setEmpYear(empYear);
		// update year
	}
